...
transaction1 = Transaction(user1, "11/05/20", "19:40", merchant1, 6.50, tag3)
transaction_repository.save(transaction1)
transaction2 = Transaction(user2, "10/08/20", "14:32", merchant2, 9.99, tag4)
transaction_repository.save(transaction2)
transaction3 = Transaction(user3, "05/06/20", "12:20", merchant3, 59.00, tag2)
transaction_repository.save(transaction3)
transaction4 = Transaction(user1, "13/07/20", "18:55", merchant1, 6.50, tag1)
transaction_repository.save(transaction4)
transaction5 = Transaction(user2, "17/08/20", "07:29", merchant3, 19.99, tag4)
